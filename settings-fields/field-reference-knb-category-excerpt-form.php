...
function reference_knb_category_excerpt_form() {
    ...
    echo '<input name="reference_knb_category_excerpt" id="reference_knb_category_excerpt" type="number" class="small-text" min="15" placeholder="15" value="' . esc_attr( get_option( 'reference_knb_category_excerpt' ) ) . '">';
