...
function reference_knb_tag_plural_form()
{
    ...
    $tag_plural = $option->getTagPlural();
    ?>

    <input name="reference_knb_tag_plural" id="reference_knb_tag_plural" type="text" class="regular-text code" maxlength="80" value="<?php esc_attr_e($tag_plural); ?>">

    <p class="description">
        <?php esc_html_e('This option allows you to change the plural name of your knowledgebase tag archive page.', 'reference'); ?>
    </p>
