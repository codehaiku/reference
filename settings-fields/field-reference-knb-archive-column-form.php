...
function reference_knb_archive_column_form() {
    echo '<select name="reference_knb_archive_column" class="reference_select" id="reference_knb_archive_column">';
        echo '<option value="1" ' . selected( absint( esc_attr( get_option( 'reference_knb_archive_column' ) ) ), 1 ) . '>1</option>';
        echo '<option value="2" ' . selected( absint( esc_attr( get_option( 'reference_knb_archive_column' ) ) ), 2 ) . '>2</option>';
        echo '<option value="3" ' . selected( absint( esc_attr( get_option( 'reference_knb_archive_column' ) ) ), 3 ) . '>3</option>';
    echo '</select>';
