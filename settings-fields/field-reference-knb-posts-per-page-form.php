...
function reference_knb_posts_per_page_form() {
    ...
    echo '<input name="reference_knb_posts_per_page" id="reference_knb_posts_per_page" type="number" class="small-text" min="1" max="10" placeholder="10" value="' . esc_attr( get_option( 'reference_knb_posts_per_page' ) ) . '">';
