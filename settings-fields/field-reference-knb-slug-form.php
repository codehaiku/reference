...
function reference_knb_slug_form()
{
    ...
    $slug = $option->getKnbSlug();
    ?>

    <input name="reference_knb_slug" id="reference_knb_slug" type="text" class="regular-text code" maxlength="80" value="<?php esc_attr_e($slug); ?>">

    <p class="description">
        <?php esc_html_e('This option allows you to change the slug of your post archive page.', 'reference'); ?>
    </p>
