...
function reference_knb_category_singular_form()
{
    ...
    $category_singular = $option->getCategorySingular();
    ?>

    <input name="reference_knb_category_singular" id="reference_knb_category_singular" type="text" class="regular-text code" maxlength="80" value="<?php esc_attr_e($category_singular); ?>">

    <p class="description">
        <?php esc_html_e('This option allows you to change the singular name of your knowledgebase category archive page.', 'reference'); ?>
    </p>
