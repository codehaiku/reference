...
final class PostType
{
    ...
    public function register_post_type_and_taxonomies()
    {
        ...
        $post_type_args = array(
    		...
    		'show_in_menu'       => true,
    		'query_var'          => true,
    		'rewrite'            => array('slug' => get_option('reference_knb_slug')),
    	...
    	$category_args = array(
    		...
    		'query_var'         => true,
    		'rewrite'           => array('slug' => get_option('reference_knb_category_slug')),
    	);

    	register_taxonomy('knb-categories', array('knowledgebase'), $category_args);

        $tag_labels = array(
    		'name'                       => _x(get_option('reference_knb_tag_plural'), 'taxonomy general name', 'reference'),
    		'singular_name'              => _x(get_option('reference_knb_tag_singular'), 'taxonomy singular name', 'reference'),
    	...
    	$tag_args = array(
    		...
    		'query_var'             => true,
    		'rewrite'               => array('slug' => get_option('reference_knb_tag_slug')),
    	);
