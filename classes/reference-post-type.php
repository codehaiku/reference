...
final class PostType
{
     ...
     * @return void
     */
    public function __construct($_name, $_version, $loader)
    {
    ...
    */
    public function registerPostTypeAndTaxonomies()
    {
        ...
        $post_type_labels = array(
            'name' => _x(
                $reference_plural_option, 'post type general name', 'reference'
            ),
            'singular_name' => _x(
                $reference_singular_option, 'post type singular name', 'reference'
            ),
            'menu_name' => _x(
                'Reference', 'admin menu', 'reference'
            ),
            'name_admin_bar' => _x(
                'Article', 'add new on admin bar', 'reference'
            ),
            'add_new' => _x(
                'Add New', 'Article', 'reference'
            ),
        ...
        $category_labels = array(
            'name' => _x(
                $category_plural_option, 'taxonomy general name', 'reference'
            ),
            'singular_name' => _x(
                $category_singular_option, 'taxonomy singular name', 'reference'
            ),
            'search_items' => esc_html__(
        ...
        $tag_labels = array(
            'name' => _x(
                $tag_plural_option, 'taxonomy general name', 'reference'
            ),
            'singular_name' => _x(
                $tag_singular_option, 'taxonomy singular name', 'reference'
            ),
            'search_items' => esc_html__(
            ...
            'separate_items_with_commas' => esc_html__(
                'Separate tag with commas', 'reference'
            ),
            'add_or_remove_items' => esc_html__(
                'Add or remove tags', 'reference'
            ),
            'choose_from_most_used' => esc_html__(
                'Choose from the most used tags', 'reference'
            ),
            'not_found' => esc_html__(
                'No tags found.', 'reference'
            ),
            'menu_name' => esc_html__(
                'Tags', 'reference'
            ),
